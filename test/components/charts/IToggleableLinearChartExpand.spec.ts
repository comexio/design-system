...
import LToggleableLinearChartExpand from '~/src/components/charts/LToggleableLinearChartExpand.vue'
...
describe('linearChartExpand component', () => {
  let linearChartExpand: Wrapper<LToggleableLinearChartExpand>

  beforeAll(() => {
    linearChartExpand = mount(LToggleableLinearChartExpand, {
      ...defaultParams
    })
  })
  ...
  it('render with another text to hide action', async () => {
    ...
    const actionElement = linearChartExpand.find('.LToggleableLinearChartExpand__header__action')
  ...
  it('render header items', async () => {
    const headerItems = () => linearChartExpand.findAll('.LToggleableLinearChartExpand__table__title')
  ...
  it('render list items', async () => {
    ...
    const lines = () => linearChartExpand.findAll('.LToggleableLinearChartExpand__table__line')
    expect(lines().length).toBe(7)
  })

  it('render loading', async () => {
    const loading = () => linearChartExpand.find('.LToggleableLinearChartExpand__loading')
  ...
  it('emit expand event', async () => {
    const expandToggle = () => linearChartExpand.find('.LToggleableLinearChartExpand__header__action')
...
describe('linearChartExpand component with data and nonClickableItems', () => {
  ...
  it('check eventClicks on nonClickableItems and clickableItems', async () => {
    const dataItem = () => linearChartExpand.findAll('.LToggleableLinearChartExpand__table__line')
