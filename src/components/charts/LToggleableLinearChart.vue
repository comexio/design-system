      ...
      <v-list>
        ...
        >
          <l-toggleable-linear-chart-line
            ...
            @lineToggled="data => $emit('lineToggled', data)"
          >
...
<script>
import LToggleableLinearChartLine from '~/src/components/charts/LToggleableLinearChartLine'
import LButtonNew from '~/src/components/buttons/LButtonNew.vue'
import colorsMixin from '~/mixins/colors.mixin'

export default {
  name: 'LToggleableLinearChart',
  emits: ['lineToggled'],
  components: {
