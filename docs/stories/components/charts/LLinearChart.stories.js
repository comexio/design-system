...
export default {
  ...
  argTypes: {
    data: {
      control: "object",
      description: "Data object: label, percentage, total, quantity, value"
    },
    colors: { control: "array", description: "Colors array (hexadecimal)" },
    itemsWithoutDetails: {
      control: "array",
      description: "Receives info about when it should shows details icon"
    },
    translationLine: {
      control: "object",
      description: "Subtitles translation object: value, records, seeMore"
    },
    isExpanded: {
      control: "boolean",
      description: "Chart expanded: true / Chart minimized: false"
    },
    isExpandable: {
      control: "boolean",
      description: "Chart expandable: true / Chart not expandable: false"
    },
    expandList: {
      action: "expandList",
      description: 'Toggle chart expanded when "See more" clicked'
    },
...
Minimized.args = {
  ...
  colors: ["#51a59a", "#e291da", "#7dbaff", "#ffb57d", "#ae77d8"],
  translationLine: {
    value: "Shipments",
    records: "Share of Shipments",
    seeMore: "See more"
  }
};
