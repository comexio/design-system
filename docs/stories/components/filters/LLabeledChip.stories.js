...
export default {
  ...
  argTypes: {
    item: {
      control: "object",
      description:
        "Data object that will be used in the chip content: text, number, filter"
    },
    removeFilter: {
      action: "remove-filter",
      description: "Event filter removed"
    }
  }
};
...
const Template = (args, { argTypes }) => ({
  ...
  template:
    '<l-labeled-chip v-bind="$props" @remove-filter="removeFilter" style="width:240"> </l-labeled-chip>'
});
